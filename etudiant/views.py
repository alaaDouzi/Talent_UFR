...
from .serializers import StageSerializer, OrganismeAccueilSerializer, LieuSerializer, ResponsableAdministratifSerializer, ProposeurStageSerializer, MaitreStageSerializer, StageCreateSerializer
...
####################
        ...
        if stage_serializer.is_valid():
            ...
            #for mot_cle in stage.list_mot_cle.all():print(MotCleSerializer(mot_cle).data)
